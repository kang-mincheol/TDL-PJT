...
public class ListAction implements CommandAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		// TODO Auto-generated method stub
		    System.out.println("================공지사항 리스트 actionPost - ListAction클래스 시작");
			...
			TDLNoticeDAO dbPro=new TDLNoticeDAO(); //공지사항 DAO  
		...
		//2.request객체에 저장
			...
			System.out.println("================공지사항 리스트 actionPost - ListAction클래스 끝================");
		//3.공유해서 이동할 수 있도록 설정
		return "/index/TDL_NOTICE/list.jsp"; //request.getAttribute("currentPage")=${currentPage}
	}
