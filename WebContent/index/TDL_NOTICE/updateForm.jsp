	...
	<div class="container">
		...
		<div class="form-widget">
			...
			<form class="nobottommargin" id="template-contactform"
				name="writeform"
				action="/TDL/index/TDL_NOTICE/updatePro.do?pageNum=${pageNum}"
				method="post" >
				
				<input type="hidden" name="TN_num" value="${article.TN_num }">
				
				<div class="form-process"></div>
				
				<div class="col_full">
					<label for="template-contactform-subject">제목 <small>*</small><font id="titletResult" color="red">제목을 입력하세요</font></label>
					<input type="text" name="TN_title" value="${article.TN_title }"
				...
				<div class="col_full">
					...
					<textarea class="required sm-form-control" name="TN_content"
						rows="6" cols="30">${article.TN_content }</textarea>
				</div>
