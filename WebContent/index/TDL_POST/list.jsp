			...
			<div class="board-list-wrap borard-list-con">
				...
				<c:forEach var="article" items="${articleList}">
					<ul class="row">
						...
						<li class="col-md-6 col-xs-6"><a href="/TDL/index/TDL_POST/content.do?TP_num=${article.TP_num}&pageNum=${pgList.currentPage}&TP_id=${article.TP_id}&TU_id=${TU_id}">${article.TP_title}</a></li>
		...
		<div class="row">
			<div class="col-12 col-md-2 nopadding form-row">
				<div class="col-4 col-md-12">
					...
					<c:if test="${TU_id==null }">
						<button class="btn btn-success write-btn btn-block" onclick="comment()">글쓰기</button>
					</c:if>
				</div>	
			</div>
