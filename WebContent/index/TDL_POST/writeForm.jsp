	...
	<div class="container">		
		...
		<div class="form-widget">
			...
			<div class="form-result"></div>
				...
				action="/TDL/index/TDL_POST/writePro.do" method="post" onsubmit="return textCheck()">
			...
			<input type="hidden" name="TU_id" value="${TU_id }">
				...
				<div class="col_full">
					...
					<input type="text" id="TP_title" name="TP_title" value="" class="required sm-form-control" />
					<label id="test"></label>
				</div>
				...
				<div class="col_full">
					...
					<textarea class="required sm-form-control" id="TP_content" name="TP_content" rows="6" cols="30" ></textarea>
				</div>
				...
				<div class="row">
					<div class="col-6 col-sm-6">
						<a href="/TDL/index/TDL_POST/list.do"><button class="btn btn-success" onClick="onlyList()">목록으로</button></a>
					</div>
